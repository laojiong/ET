...
namespace BM
{
    ...
    public partial class BundleMasterWindow : EditorWindow
    {
        ...
        /// 分包文件资源索引配置
        /// </summary>
        public static string AssetLoadTablePath = "Assets/Scripts/Editor/BundleMasterEditor/BuildSettings/AssetLoadTable.asset";

        /// <summary>
        /// 分包配置信息
        /// </summary>
        public static string AssetsLoadSettingPath = "Assets/Scripts/Editor/BundleMasterEditor/BuildSettings/AssetsLoadSetting";
        
        /// <summary>
        /// 原生资源包配置信息
        /// </summary>
        public static string AssetsOriginSettingPath = "Assets/Scripts/Editor/BundleMasterEditor/BuildSettings/AssetsOriginSetting";
